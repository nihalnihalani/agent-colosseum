...
export function AgentSelector({
  ...
  const borderColor = color === 'red' ? 'border-rose-500/20' : 'border-indigo-500/20';
  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      ...
      <button
        ...
        className={cn(
          "w-full flex items-center justify-between p-3 rounded-xl border bg-white/[0.02] transition-all duration-200 group",
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-50 w-full mt-2 p-1.5 rounded-xl bg-[#0a0a0f] border border-white/10 shadow-2xl shadow-black/50 overflow-hidden"
          >
