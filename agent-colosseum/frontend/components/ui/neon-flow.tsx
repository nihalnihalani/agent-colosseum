...
export function TubesBackground({ 
  ...
  useEffect(() => {
    ...
    const initTubes = async () => {
      ...
      try {
        // Bypass Turbopack's import() interception by using an indirect call.
        // This makes the browser's native dynamic import handle the external URL.
        const CDN_URL = 'https://cdn.jsdelivr.net/npm/threejs-components@0.0.19/build/cursors/tubes1.min.js';
        const importModule = new Function('url', 'return import(url)');
        const module = await importModule(CDN_URL);
